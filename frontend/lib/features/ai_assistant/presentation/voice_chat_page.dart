                ...
                children: [
                  ...
                  if (voiceState.voiceState == VoiceState.speaking)
                    Padding(
                      ...
                      child: AISpeakingIndicator(
                          isSpeaking: true, color: AppColors.primary),
                    ),
                ],
              ),
            ),
            ...
            Row(children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: voiceState.voiceState == VoiceState.idle
                      ? AppColors.success
                      : AppColors.warning,
                ),
              ),
              ...
              Container(
                ...
                child: const Text('Claude + Whisper + ElevenLabs',
                    style: TextStyle(
                        fontSize: 10,
      ...
      return Container(
        ...
        child: Row(
          children: [
            ...
            IconButton.filled(
              onPressed: voiceState.voiceState == VoiceState.processing
                  ? null
                  : _sendText,
        ...
        children: [
          ...
          if (voiceState.voiceState == VoiceState.listening)
            Padding(
              ...
              child:
                  VoiceWaveform(isActive: true, color: Colors.red, height: 50),
            )
          else if (voiceState.voiceState == VoiceState.speaking)
            Padding(
              padding: const EdgeInsets.only(bottom: 16),
              child: VoiceWaveform(
                  isActive: true, color: AppColors.primary, height: 50),
            ),
          ...
          Row(
            ...
            children: [
              ...
              PulsingMicButton(
                ...
                onTap: voiceState.voiceState == VoiceState.processing ||
              ...
              if (voiceState.voiceState == VoiceState.speaking)
                IconButton(
                  onPressed: () =>
                      ref.read(voiceChatProvider.notifier).onSpeakingDone(),
