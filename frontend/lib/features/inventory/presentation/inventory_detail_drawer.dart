...
class InventoryDetailDrawer extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<InventoryDetailDrawer> createState() =>
      _InventoryDetailDrawerState();
}

class _InventoryDetailDrawerState extends ConsumerState<InventoryDetailDrawer>
              ...
              children: [
                    ...
                    children: [
                      ...
                      if (item.warehouseStocks.isEmpty)
                        ...
                        ...item.warehouseStocks.map((ws) {
                          final pct = item.totalStock > 0
                              ? ws.quantity / item.totalStock
                              : 0.0;
                          return Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Text('Warehouse #${ws.warehouseId}',
                                          style: const TextStyle(
                                              fontWeight: FontWeight.w600)),
                                      Text(
                                          '${ws.quantity.toStringAsFixed(1)} $unit',
                                          style: const TextStyle(
                                              fontWeight: FontWeight.w700)),
                                    ],
                                  ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                          'Avg cost: \$${ws.avgCost.toStringAsFixed(2)}',
                                          style: const TextStyle(
                                              fontSize: 11,
                                              color: AppColors.textSecondary)),
                                      Text(
                ...
                SingleChildScrollView(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Ask AI about this item',
                      ...
                      Wrap(
                        ...
                        children: [
                          _AiChip(
                              ...
                              onTap: () => _askAi(
                                  'How many days until "${item.productName}" runs out of stock? Current stock: ${item.totalStock} ${item.baseUnit}.')),
                          _AiChip(
                              label: 'Should I reorder?',
                              onTap: () => _askAi(
                                  'Should I reorder "${item.productName}"? Stock: ${item.totalStock} ${item.baseUnit}.')),
                          _AiChip(
                              label: 'Is it dead stock?',
                              onTap: () => _askAi(
                                  'Is "${item.productName}" dead stock? Analyze its movement pattern.')),
                          _AiChip(
                              label: 'Optimal stock level?',
                              onTap: () => _askAi(
                                  'What is the optimal stock level for "${item.productName}"?')),
                        ],
                      ),
                  ...
                  child: Column(
                    children: [
                      ...
                      _ActionTile(
                          ...
                          label: 'Deduct Stock (Waste/Correction)',
                          color: AppColors.error,
                          onTap: widget.onDeductStock),
                      _ActionTile(
