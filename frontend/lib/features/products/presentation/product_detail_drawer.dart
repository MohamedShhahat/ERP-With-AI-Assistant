...
class ProductDetailDrawer extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ProductDetailDrawer> createState() =>
      _ProductDetailDrawerState();
}

class _ProductDetailDrawerState extends ConsumerState<ProductDetailDrawer>
  ...
  Future<void> _askAi(String question) async {
    ...
    try {
      ...
      setState(() => _aiInsight =
          result['response']?.toString() ?? 'No insight available');
    } catch (e) {
                      ...
                      children: [
                        ...
                        Wrap(spacing: 8, runSpacing: 8, children: [
                          _AiChip(
                              ...
                              onTap: () => _askAi(
                                  'Should I reorder product "${p.productName}"? Current stock is $totalStock ${p.baseUnit}.')),
                          _AiChip(
                              label: 'Why is demand dropping?',
                              onTap: () => _askAi(
                                  'Why might demand be dropping for "${p.productName}"?')),
                          _AiChip(
                              label: 'Best price?',
                              onTap: () => _askAi(
