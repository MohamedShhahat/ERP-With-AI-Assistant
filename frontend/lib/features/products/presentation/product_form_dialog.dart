...
class _ProductFormDialogState extends ConsumerState<ProductFormDialog> {
  ...
  void initState() {
    ...
    _purchaseCostController =
        TextEditingController(text: p?.purchaseCost ?? '0');
    _sellingPriceController =
        TextEditingController(text: p?.sellingPrice ?? '0');
  ...
  Future<void> _submit() async {
    ...
    final data = <String, dynamic>{
      ...
      'product_image': _imageUrlController.text.trim().isEmpty
          ? null
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Column(
                          children: [
                            SwitchListTile(
                              ...
                              subtitle: Text(_isMeterBased
                                  ? 'Product is measured in meters'
                                  : 'Product is measured in pieces'),
                              value: _isMeterBased,
                            ...
                            SwitchListTile(
                              ...
                              subtitle: const Text(
                                  'Enable selling by individual piece'),
                              value: _allowPieceSale,
                              onChanged: (v) =>
                                  setState(() => _allowPieceSale = v),
                              contentPadding: EdgeInsets.zero,
                              dense: true,
                            ),
                            const Divider(height: 1),
                            SwitchListTile(
                              ...
                              subtitle:
                                  const Text('Show carton as a display option'),
                              value: _allowCartonDisplay,
                              onChanged: (v) =>
                                  setState(() => _allowCartonDisplay = v),
                              contentPadding: EdgeInsets.zero,
                              dense: true,
                            ),
                          ],
                      ...
                      if (_purchaseCostController.text.isNotEmpty &&
                            ...
                            children: [
                              Expanded(
                                ...
                                child: DropdownButtonFormField<String>(
                                  ...
                                  onChanged: conv.id != null
                                      ? null
                                      : (v) {
                                          if (v != null)
                                            setState(() => conv.fromUnit = v);
                                        },
                                ),
                              ),
                              const Padding(
