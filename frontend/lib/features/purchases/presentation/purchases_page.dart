                ...
                Row(
                  children: [
                    _KpiCard(
                        ...
                        value:
                            '${(kpis['totalPurchases'] as double).toStringAsFixed(0)} IQD',
                    ...
                    _KpiCard(
                        title: 'Total Paid',
                        value:
                            '${(kpis['totalPaid'] as double).toStringAsFixed(0)} IQD',
                    ...
                    _KpiCard(
                        title: 'Total Unpaid',
                        value:
                            '${(kpis['totalUnpaid'] as double).toStringAsFixed(0)} IQD',
                ...
                Row(
                  children: [
                          ...
                          suffixIcon: _searchController.text.isNotEmpty
                              ? IconButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    ref
                                        .read(purchasesSearchProvider.notifier)
                                        .state = '';
                                  },
                                )
                              : null,
                    ...
                    _FilterChip(
                      ...
                      onTap: () => ref
                          .read(purchasesStatusFilterProvider.notifier)
                    ...
                    _FilterChip(
                      ...
                      onTap: () => ref
                          .read(purchasesStatusFilterProvider.notifier)
                          .state = PurchaseStatusFilter.paid,
                    ),
                    const SizedBox(width: 8),
                    _FilterChip(
                      label: 'Partial',
                      ...
                      onTap: () => ref
                          .read(purchasesStatusFilterProvider.notifier)
                          .state = PurchaseStatusFilter.partial,
                    ),
                    const SizedBox(width: 8),
                    _FilterChip(
                      label: 'Unpaid',
                      ...
                      onTap: () => ref
                          .read(purchasesStatusFilterProvider.notifier)
                          .state = PurchaseStatusFilter.unpaid,
                    ),
                  ],
                ),
                const SizedBox(height: 20),
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _InvoiceCard(
                            ...
                            isDark: isDark,
                            isSelected: _selectedPurchase?.purchaseInvoiceId ==
        ...
        if (_selectedPurchase != null)
          PurchaseDetailDrawer(
            ...
            onPaymentRecorded: () {
              ...
              repo
                  .getById(_selectedPurchase!.purchaseInvoiceId)
                  .then((updated) {
